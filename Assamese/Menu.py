...
class TTS(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.driver.get("http://www.iitg.ernet.in/cseweb/tts/tts/Assamese/festival/iitg_ass_arundhati/")
        time.sleep(5)
    ...
    def test_TTS(self):
        ...
        for inputLineNum, inputData in rows.items():
            ...
            time.sleep(11)
            displayed = self.driver.find_elements_by_xpath("html/body/div/center[1]/a").__len__()
            if displayed > 0:
                # Right-Click on Output Link
                download = self.driver.find_element_by_xpath("html/body/div/center[1]/a")
                ...
                str1 = str('\Audio\\' + set + '\Menus\M-' + set + '-')
